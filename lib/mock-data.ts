...
export const exchangeRates: ExchangeRate[] = [
  { pair: 'ETB/USD', from: 'ETB', to: 'USD', rate: 56.42, change: 0.15, changePercent: 0.27 },
  { pair: 'ETB/EUR', from: 'ETB', to: 'EUR', rate: 61.28, change: -0.22, changePercent: -0.36 },
  { pair: 'ETB/JPY', from: 'ETB', to: 'JPY', rate: 0.38, change: 0.01, changePercent: 2.70 },
];
...
export const coreValues = [
  { id: '1', title: 'Integrity', description: 'We uphold the highest ethical standards in all our engagements, building trust through transparency and honesty.' },
  { id: '2', title: 'Excellence', description: 'We are committed to delivering exceptional results that exceed expectations and drive measurable impact.' },
  { id: '3', title: 'Collaboration', description: 'We work closely with our clients as partners, fostering relationships built on mutual respect and shared goals.' },
  { id: '4', title: 'Innovation', description: 'We embrace creative thinking and cutting-edge methodologies to solve complex business challenges.' },
  { id: '5', title: 'Client Focus', description: 'Our clients\' success is our success. We tailor our approach to meet each client\'s unique needs.' },
];
...
export const trainingPrograms: TrainingProgram[] = [
  { id: '1', title: 'Executive Development', description: 'Strategic leadership programs for C-suite executives and board members.', icon: 'Crown' },
  { id: '2', title: 'Management Development', description: 'Building capabilities for mid-level managers and emerging leaders.', icon: 'Users' },
  { id: '3', title: 'Professional Development', description: 'Skills enhancement for individual contributors and specialists.', icon: 'GraduationCap' },
  { id: '4', title: 'IT Training', description: 'Technical skills development in software, systems, and digital tools.', icon: 'Monitor' },
  { id: '5', title: 'Finance Training', description: 'Financial analysis, reporting, and management accounting programs.', icon: 'Calculator' },
  { id: '6', title: 'Human Resources', description: 'HR best practices, talent management, and organizational development.', icon: 'Heart' },
  { id: '7', title: 'Marketing & PR', description: 'Brand building, communications, and stakeholder engagement skills.', icon: 'Megaphone' },
];

// Client logos mock data
export const clientLogos: ClientLogo[] = [
  { id: '1', name: 'Commercial Bank of Ethiopia', logo: '/images/clients/cbe.svg' },
  { id: '2', name: 'Awash Bank', logo: '/images/clients/awash.svg' },
  { id: '3', name: 'Dashen Bank', logo: '/images/clients/dashen.svg' },
  { id: '4', name: 'Bank of Abyssinia', logo: '/images/clients/boa.svg' },
  { id: '5', name: 'Zemen Bank', logo: '/images/clients/zemen.svg' },
  { id: '6', name: 'Wegagen Bank', logo: '/images/clients/wegagen.svg' },
  { id: '7', name: 'Cooperative Bank of Oromia', logo: '/images/clients/cbo.svg' },
  { id: '8', name: 'Nib International Bank', logo: '/images/clients/nib.svg' },
  { id: '9', name: 'Berhan Bank', logo: '/images/clients/berhan.svg' },
  { id: '10', name: 'Bunna Bank', logo: '/images/clients/bunna.svg' },
  { id: '11', name: 'Ethiopian Airlines', logo: '/images/clients/ethiopian.svg' },
  { id: '12', name: 'Ethio Telecom', logo: '/images/clients/ethiotelecom.svg' },
  { id: '13', name: 'Ethiopian Electric Power', logo: '/images/clients/eep.svg' },
  { id: '14', name: 'Ministry of Finance', logo: '/images/clients/mof.svg' },
  { id: '15', name: 'Development Bank of Ethiopia', logo: '/images/clients/dbe.svg' },
];
...
export const servicePillars: ServicePillar[] = [
  {
    id: '1',
    title: 'Training',
    description: 'Comprehensive learning programs designed to build capabilities at all organizational levels, from executive leadership to technical specialists.',
    offerings: [
  ...
  },
  {
    id: '2',
    title: 'Advisory',
    description: 'Strategic consulting services that help organizations navigate complex challenges and achieve sustainable growth.',
    offerings: [
      'Strategic Planning',
  ...
  },
  {
    ...
    description: 'Rigorous research and analysis that provides the insights organizations need to make informed decisions.',
    offerings: [
  ...
  },
  {
    ...
    description: 'Creative services that help organizations communicate effectively with their stakeholders and build their brands.',
    offerings: [
